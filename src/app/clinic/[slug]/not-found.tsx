...
// Klinik bulunamadiginda gosterilen sayfa.
// Klinik mevcut olmadigi icin tema rengi yoktur; notr renkler kullaniriz.
    ...
    <main className="flex min-h-screen flex-col items-center justify-center bg-gray-50 px-6 text-center">
      <div className="w-full max-w-sm rounded-3xl bg-white p-8 shadow-lg">
        ...
        <p className="mt-2 text-sm text-gray-500">
          Aradiginiz klinik mevcut degil veya baglanti hatali olabilir. Lutfen
          kliniginizden aldiginiz QR kodu veya baglantiyi kontrol edin.
        </p>
        <Link
          href="/"
