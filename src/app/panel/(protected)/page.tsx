...
import { Users, Bell, MessageSquare, AlertTriangle, Clock, CheckCircle } from 'lucide-react'
...
export default async function DashboardPage() {
  ...
  const [
    { count: activePatients }, { count: openAlerts }, { count: unreadMsgs },
    { data: recentAlerts }, { data: recentConvs },
  ] = await Promise.all([
